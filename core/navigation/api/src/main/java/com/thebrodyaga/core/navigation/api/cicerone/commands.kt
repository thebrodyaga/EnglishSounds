 ...
 *
 * That can be processed by [com.thebrodyaga.core.navigation.api.cicerone.Navigator]
 */
interface Command
 ...
 *
 * Behavior in the case when no needed screens found depends on an implementation of the [com.thebrodyaga.englishsounds.core.navigation.api.cicerone.Navigator]
